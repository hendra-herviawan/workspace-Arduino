 ...
 *      Ref :
 *      1. http://forum.arduino.cc/index.php/topic,128635.0.html
 *      2. http://hmario.home.xs4all.nl/arduino/LiquidCrystal_I2C/
 *      3. https://bitbucket.org/fmalpartida/new-liquidcrystal/wiki/Home
 *      4. http://wentztech.com/radio/arduino/files/LCDI2C.html
 *      5. http://playground.arduino.cc/Code/LCDi2c#.UwIYNKGJrOw - Old
 */

#ifndef DisplayLCD_I2CModul_H_
#define DisplayLCD_I2CModul_H_
